...
insert into tbl_usuarios values('user','admin','Pedro','Casals','Admin',getdate())
...
as
insert into tbl_visitantes ( nombre, apellido, edificio, aula, telefono, hora_entrada, hora_salida, carrera, correo, matricula, motivo_visita) 
                   values  (@nombre,@apellido,@edificio,@aula,@telefono,@hora_entrada,@hora_salida,@carrera,@correo,@matricula,@motivo_visita)
go
